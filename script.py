...
l=im.recommend(user_id)# RETURN THE DATAFRAME
print(l)
#SO THIS IS THE RECOMMADATION USING THE COOCCURENCE MATRIX.....


##############################################################################
check=test_data['user_id'].tolist()
u_id=check[3]
#print(u_id)
im.create(train_data,'user_id','movie title')
l=im.get_user_items(u_id)
####################################################
